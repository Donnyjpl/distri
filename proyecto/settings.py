"""
Django settings for distri project.
...
# Inicializa
env = environ.Env(
    # por si quieres valores por defecto
    DEBUG=(bool, False)
)
...
SECRET_KEY = "django-insecure-lx)6-@sj%b0%(@p9259uamei2c(nvconbnrjf#3dw$hd5711)&"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # 👇 Agrega esta línea
               'web.context_processors.categorias_y_datos_adicionales',
            ],
        },
    },
]
